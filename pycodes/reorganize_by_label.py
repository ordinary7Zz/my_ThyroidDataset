...
SRC_IMAGE_DIR = "/mnt/wangbd8/workspace/DataSets/ThyroidAgent/train_val_test/all_datasets_cls/images"

# 源掩码目录
SRC_MASK_DIR = "/mnt/wangbd8/workspace/DataSets/ThyroidAgent/train_val_test/all_datasets_cls/masks"

# 分类标签 JSON 文件路径
JSON_PATH = "/mnt/wangbd8/workspace/DataSets/ThyroidAgent/train_val_test/all_datasets_cls/all_datasets_label.json"

# 目标根目录（会自动在其下创建 images/{标签值}/ 和 masks/{标签值}/ 子目录）
TARGET_BASE_DIR = "/mnt/wangbd8/workspace/DataSets/ThyroidAgent/train_val_test/all_datasets_cls_by_label"
