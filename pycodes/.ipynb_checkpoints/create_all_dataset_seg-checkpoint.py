...
if __name__ == "__main__":
    ...
    image_dirs: List[str] = [
        ...
        "/mnt/wangbd8/workspace/DataSets/ThyroidAgent/train_val_test/PKTN_comprehensive/train/images",
    ...
    mask_dirs: List[str] = [
        ...
        "/mnt/wangbd8/workspace/DataSets/ThyroidAgent/train_val_test/PKTN_comprehensive/train/masks",
    ...
    # ======= 2. 配置要复制到的目标路径 =======
    dst_image_dir = "/mnt/wangbd8/workspace/DataSets/ThyroidAgent/train_val_test/all_datasets_seg/images"
    dst_mask_dir = "/mnt/wangbd8/workspace/DataSets/ThyroidAgent/train_val_test/all_datasets_seg/masks"
    ...
    out_json_path = "/mnt/wangbd8/workspace/DataSets/ThyroidAgent/train_val_test/test/test_label.json"
